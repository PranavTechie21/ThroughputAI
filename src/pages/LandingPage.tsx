...
export default function IndianRailwayLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f16] text-white flex flex-col relative overflow-hidden">
  ...
  <div className="absolute inset-0 bg-gradient-to-r from-[#0b0f16] via-transparent to-[#0b0f16]" />
  <div className="absolute inset-0 bg-gradient-to-b from-[#0b0f16]/20 via-transparent to-[#0b0f16]/60" />
      </div>
  ...
  <div className="w-full max-w-6xl mx-auto">
          {/* Eyebrow */}
          <div className="text-sm tracking-[0.3em] text-[#cbd5e1]/70 uppercase">Indian Railways</div>

          {/* Hero */}
          <h1 className="mt-4 font-bold leading-tight text-left text-transparent bg-clip-text bg-gradient-to-r from-[#FF9933] via-white to-[#138808]"
              style={{ fontSize: "clamp(2.75rem, 6vw, 5rem)" }}>
            Bharat Rail Control
          </h1>
          <p className="mt-4 max-w-2xl text-left text-[#d1d5db]"
          ...
          <div className="mt-10 flex items-center gap-6">
            ...
            >
              ...
              <span className="relative inline-flex items-center gap-3 rounded-full border border-[#ffb067] bg-[#ff9933] px-8 py-3 text-base font-semibold text-white shadow-[0_8px_30px_rgb(255,153,51,0.35)] transition-transform duration-300 hover:scale-[1.03]">
          ...
          <div className="mt-12 flex items-center gap-3">
            ...
            <span className="inline-block h-1.5 w-24 rounded-full bg-white/90" />
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              ...
              <div className="mt-1 text-sm text-[#9aa8bf]">Real-time monitoring</div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <div className="text-3xl font-bold">AI</div>
              <div className="mt-1 text-sm text-[#9aa8bf]">Predictive analytics</div>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
              <div className="text-3xl font-bold text-[#138808]">99.9%</div>
              <div className="mt-1 text-sm text-[#9aa8bf]">System uptime</div>
            </div>
          </div>
        </div>
      </main>
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-white/10 bg-[#0b0f16]">
        <div className="max-w-6xl mx-auto px-6 sm:px-10 py-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2 text-sm text-[#9aa8bf]">
          ...
          <div className="flex items-center gap-6 text-sm text-[#9aa8bf]">
